...
# Create a dictionary of available models mapping their names to the actual model objects
available_tuned_models = {
    name: info['model'] for name, info in best_tuned_models.items()
}
...
model_data = {
    ...
    'available_models': available_tuned_models,
